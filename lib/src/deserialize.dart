...
final _regMap = RegExp(r'^Map<String,(.*)>$');
  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'IsPaletteCompleted200Response':
          return IsPaletteCompleted200Response.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'UpdateNotificationRequest':
          return UpdateNotificationRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
