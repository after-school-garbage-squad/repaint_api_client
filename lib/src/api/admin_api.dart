...
class AdminApi {
  ...
  Future<Response<void>> deleteSpot({
    ...
    try {
      _bodyData = jsonEncode(deleteSpotRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> disableBonus({
    required String eventId,
    required DeleteSpotRequest deleteSpotRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/admin/event/{eventId}/traffic/disable-bonus'
        .replaceAll('{' r'eventId' '}', eventId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> enableBonus({
    required String eventId,
    required EnableBonusRequest enableBonusRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/event/{eventId}/traffic/enable-bonus'
        .replaceAll('{' r'eventId' '}', eventId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
    ...
    try {
      _bodyData = jsonEncode(enableBonusRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> finishEvent({
    required String eventId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/event/{eventId}/finish'
        .replaceAll('{' r'eventId' '}', eventId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
  ...
  Future<Response<GetDefaultImageURL200Response>> getDefaultImageURL({
    ...
    return Response<GetDefaultImageURL200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> registerDefaultImage({
    ...
    try {
      _bodyData = FormData.fromMap(
        <String, dynamic>{"${image.filename}": image},
      );
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
