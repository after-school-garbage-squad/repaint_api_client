...
_responseData = rawData == null ? null : deserialize<GetCurrentImage200Response, GetCurrentImage200Response>(rawData, 'GetCurrentImage200Response', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetImageURL200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetImageURL200Response>> getImageURL({ 
    required String visitorID,
...
_bodyData=jsonEncode(setCurrentImageRequest);
    ...
    GetImageURL200Response? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<GetImageURL200Response, GetImageURL200Response>(rawData, 'GetImageURL200Response', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetImageURL200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
